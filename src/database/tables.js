const TBL_USERS = "" +
    "CREATE TABLE IF NOT EXISTS `users` (" +
        ...
        "`poniverse_id` INT(10) UNSIGNED DEFAULT NULL," +
        "PRIMARY KEY(`id`)," +
        "UNIQUE(`name`)) " +
    "CHARACTER SET utf8";
...
const TBL_CHANNELS = "" +
    "CREATE TABLE IF NOT EXISTS `channels` (" +
        ...
        "`time` BIGINT NOT NULL," +
        "`currently_playing_title` VARCHAR(100) NOT NULL DEFAULT ''," +
        "`user_count` INT(10) UNSIGNED NOT NULL DEFAULT '0'," +
        "`page_title` VARCHAR(255) NOT NULL DEFAULT '', " +
        "`is_public` INT(1) UNSIGNED NOT NULL DEFAULT '1', " +
        "PRIMARY KEY (`id`), UNIQUE(`name`), INDEX(`owner`), " +
        "INDEX(currently_playing_title), " +
        "INDEX(user_count), " +
        "INDEX(is_public) " +
    ") " +
    "CHARACTER SET utf8";
